...
@___asan_gen_.6 = private constant [13 x i8] c"demo/demo.cc\00", align 1
...
@___asan_gen_.11 = private unnamed_addr constant [13 x i8] c"demo/demo.cc\00", align 1
@___asan_gen_.12 = private unnamed_addr constant { [13 x i8]*, i32, i32 } { [13 x i8]* @___asan_gen_.11, i32 38, i32 26 }
@___asan_gen_.13 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.14 = private unnamed_addr constant [13 x i8] c"demo/demo.cc\00", align 1
@___asan_gen_.15 = private unnamed_addr constant { [13 x i8]*, i32, i32 } { [13 x i8]* @___asan_gen_.14, i32 39, i32 28 }
@___asan_gen_.16 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.17 = private unnamed_addr constant [13 x i8] c"demo/demo.cc\00", align 1
@___asan_gen_.18 = private unnamed_addr constant { [13 x i8]*, i32, i32 } { [13 x i8]* @___asan_gen_.17, i32 40, i32 27 }
@___asan_gen_.19 = private unnamed_addr constant [17 x i8] c"<string literal>\00", align 1
@___asan_gen_.20 = private unnamed_addr constant [13 x i8] c"demo/demo.cc\00", align 1
@___asan_gen_.21 = private unnamed_addr constant { [13 x i8]*, i32, i32 } { [13 x i8]* @___asan_gen_.20, i32 67, i32 10 }
...
entry:
  call void @__asan_before_dynamic_init(i64 ptrtoint ([13 x i8]* @___asan_gen_.6 to i64))
