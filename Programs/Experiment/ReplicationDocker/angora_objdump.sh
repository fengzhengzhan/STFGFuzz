...
cp -r binutils_gdb_cve2016_nocheckout track
cd track
...
export ANGORA_TAINT_RULE_LIST=/root/datav5/Angora-1.2.2/experiment/objdump/track/zlib_abilist.txt
make clean
USE_TRACK=1 make
make install
cd ..
...
cp -r binutils_gdb_cve2016_nocheckout fast
cd fast
