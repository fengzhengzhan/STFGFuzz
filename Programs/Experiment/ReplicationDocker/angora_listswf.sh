...
export ANGORA_TAINT_RULE_LIST=/root/datav5/Angora-1.2.2/experiment/listswf/track/zlib_abilist.txt  # change it
make clean
USE_TRACK=1 make
make install
cd ..
...
${ANGORA}/angora_fuzzer -i seeds -o output -j 1 -t ./track/util/listswf -- ./fast/util/listswf @@
